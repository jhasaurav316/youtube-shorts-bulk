#!/usr/bin/env node
// ============================================================================
// Auto-Register All Vegetable Name Compositions in VegetableRoot.tsx
// ============================================================================
// Reads vegetable-names/catalog.json and generates a new VegetableRoot.tsx that
// registers every video as a portrait (1080x1920) Remotion composition.
//
// Usage:
//   node vegetable-names/register-compositions.js
// ============================================================================
...
const CATALOG_PATH = path.join(PROJECT_ROOT, "vegetable-names", "catalog.json");
const ROOT_TSX_PATH = path.join(PROJECT_ROOT, "src", "VegetableRoot.tsx");
const BACKUP_PATH = path.join(PROJECT_ROOT, "src", "VegetableRoot.tsx.backup");

const FPS = 30;

// ---------- Helpers ----------

// Convert an id like "vegetables-green-veggies-1" to PascalCase "VegetablesGreenVeggies1"
...
function main() {
  console.log("====================================================");
  console.log("  Register All Vegetable Names in VegetableRoot.tsx");
  console.log("====================================================\n");
  ...
  // Back up existing VegetableRoot.tsx
  if (fs.existsSync(ROOT_TSX_PATH)) {
    fs.copyFileSync(ROOT_TSX_PATH, BACKUP_PATH);
    console.log(`Backed up existing VegetableRoot.tsx to VegetableRoot.tsx.backup`);
  }

  // ---------- Generate VegetableRoot.tsx content ----------
  let content = "";
  ...
  content += `export const VegetableRemotionRoot: React.FC = () => {\n`;
  content += `  return (\n`;
  content += `    <>\n`;
  ...
  console.log(`\nVegetableRoot.tsx generated successfully!`);
