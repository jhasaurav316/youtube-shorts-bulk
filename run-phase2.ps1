# ============================================================================
# ONE-CLICK Phase 2 Render (50 Videos)
# Birds (remaining 10) + Fruits (30) + Vegetables (10)
# Usage: cd C:\test\youtube-shorts-bulk && .\run-phase2.ps1
# ============================================================================
...
Write-Host "  PHASE 2: 50 Videos (10 Birds + 30 Fruits + 10 Vegetables)" -ForegroundColor Cyan
Write-Host "================================================================" -ForegroundColor Cyan
Write-Host ""
...
$catalogs = @(
    @{ Path = "bird-names\catalog.json"; Name = "Birds (remaining)"; FromIdx = 20; ToIdx = 29 },
    @{ Path = "fruit-names\catalog.json"; Name = "Fruits"; FromIdx = 0; ToIdx = 29 },
    @{ Path = "vegetable-names\catalog.json"; Name = "Vegetables"; FromIdx = 0; ToIdx = 9 }
)
...
node (Join-Path $ProjectDir "fruit-names\register-compositions.js")
