#!/usr/bin/env node
// ============================================================================
// Auto-Register All Animal Name Compositions in InsectRoot.tsx
// ============================================================================
// Reads insect-names/catalog.json and generates a new InsectRoot.tsx that
// registers every video as a portrait (1080x1920) Remotion composition.
//
// Usage:
//   node insect-names/register-compositions.js
// ============================================================================
...
const CATALOG_PATH = path.join(PROJECT_ROOT, "insect-names", "catalog.json");
const ROOT_TSX_PATH = path.join(PROJECT_ROOT, "src", "InsectRoot.tsx");
const BACKUP_PATH = path.join(PROJECT_ROOT, "src", "InsectRoot.tsx.backup");
...
function main() {
  console.log("============================================");
  console.log("  Register All Insect Names in InsectRoot.tsx");
  console.log("============================================\n");
  ...
  // Back up existing InsectRoot.tsx
  if (fs.existsSync(ROOT_TSX_PATH)) {
    fs.copyFileSync(ROOT_TSX_PATH, BACKUP_PATH);
    console.log(`Backed up existing InsectRoot.tsx to InsectRoot.tsx.backup`);
  }

  // ---------- Generate InsectRoot.tsx content ----------
  let content = "";
  ...
  content += `export const InsectRemotionRoot: React.FC = () => {\n`;
  content += `  return (\n`;
  content += `    <>\n`;
  ...
  console.log(`\nInsectRoot.tsx generated successfully!`);
