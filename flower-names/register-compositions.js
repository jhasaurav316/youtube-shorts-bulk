#!/usr/bin/env node
// ============================================================================
// Auto-Register All Animal Name Compositions in FlowerRoot.tsx
// ============================================================================
// Reads flower-names/catalog.json and generates a new FlowerRoot.tsx that
// registers every video as a portrait (1080x1920) Remotion composition.
//
// Usage:
//   node flower-names/register-compositions.js
// ============================================================================
...
const CATALOG_PATH = path.join(PROJECT_ROOT, "flower-names", "catalog.json");
const ROOT_TSX_PATH = path.join(PROJECT_ROOT, "src", "FlowerRoot.tsx");
const BACKUP_PATH = path.join(PROJECT_ROOT, "src", "FlowerRoot.tsx.backup");
...
function main() {
  console.log("============================================");
  console.log("  Register All Flower Names in FlowerRoot.tsx");
  console.log("============================================\n");
  ...
  // Back up existing FlowerRoot.tsx
  if (fs.existsSync(ROOT_TSX_PATH)) {
    fs.copyFileSync(ROOT_TSX_PATH, BACKUP_PATH);
    console.log(`Backed up existing FlowerRoot.tsx to FlowerRoot.tsx.backup`);
  }

  // ---------- Generate FlowerRoot.tsx content ----------
  let content = "";
  ...
  content += `export const FlowerRemotionRoot: React.FC = () => {\n`;
  content += `  return (\n`;
  content += `    <>\n`;
  ...
  console.log(`\nFlowerRoot.tsx generated successfully!`);
