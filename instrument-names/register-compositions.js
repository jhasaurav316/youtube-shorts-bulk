#!/usr/bin/env node
// ============================================================================
// Auto-Register All Animal Name Compositions in InstrumentRoot.tsx
// ============================================================================
// Reads instrument-names/catalog.json and generates a new InstrumentRoot.tsx that
// registers every video as a portrait (1080x1920) Remotion composition.
//
// Usage:
//   node instrument-names/register-compositions.js
// ============================================================================
...
const CATALOG_PATH = path.join(PROJECT_ROOT, "instrument-names", "catalog.json");
const ROOT_TSX_PATH = path.join(PROJECT_ROOT, "src", "InstrumentRoot.tsx");
const BACKUP_PATH = path.join(PROJECT_ROOT, "src", "InstrumentRoot.tsx.backup");
...
function main() {
  console.log("============================================");
  console.log("  Register All Instrument Names in InstrumentRoot.tsx");
  console.log("============================================\n");
  ...
  // Back up existing InstrumentRoot.tsx
  if (fs.existsSync(ROOT_TSX_PATH)) {
    fs.copyFileSync(ROOT_TSX_PATH, BACKUP_PATH);
    console.log(`Backed up existing InstrumentRoot.tsx to InstrumentRoot.tsx.backup`);
  }

  // ---------- Generate InstrumentRoot.tsx content ----------
  let content = "";
  ...
  content += `export const InstrumentRemotionRoot: React.FC = () => {\n`;
  content += `  return (\n`;
  content += `    <>\n`;
  ...
  console.log(`\nInstrumentRoot.tsx generated successfully!`);
