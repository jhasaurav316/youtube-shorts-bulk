#!/usr/bin/env node
// ============================================================================
// Auto-Register All Animal Name Compositions in SpaceRoot.tsx
// ============================================================================
// Reads space-names/catalog.json and generates a new SpaceRoot.tsx that
// registers every video as a portrait (1080x1920) Remotion composition.
//
// Usage:
//   node space-names/register-compositions.js
// ============================================================================
...
const CATALOG_PATH = path.join(PROJECT_ROOT, "space-names", "catalog.json");
const ROOT_TSX_PATH = path.join(PROJECT_ROOT, "src", "SpaceRoot.tsx");
const BACKUP_PATH = path.join(PROJECT_ROOT, "src", "SpaceRoot.tsx.backup");
...
function main() {
  console.log("============================================");
  console.log("  Register All Space Names in SpaceRoot.tsx");
  console.log("============================================\n");
  ...
  // Back up existing SpaceRoot.tsx
  if (fs.existsSync(ROOT_TSX_PATH)) {
    fs.copyFileSync(ROOT_TSX_PATH, BACKUP_PATH);
    console.log(`Backed up existing SpaceRoot.tsx to SpaceRoot.tsx.backup`);
  }

  // ---------- Generate SpaceRoot.tsx content ----------
  let content = "";
  ...
  content += `export const SpaceRemotionRoot: React.FC = () => {\n`;
  content += `  return (\n`;
  content += `    <>\n`;
  ...
  console.log(`\nSpaceRoot.tsx generated successfully!`);
