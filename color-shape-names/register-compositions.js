#!/usr/bin/env node
// ============================================================================
// Auto-Register All Animal Name Compositions in ColorshapeRoot.tsx
// ============================================================================
// Reads color-shape-names/catalog.json and generates a new ColorshapeRoot.tsx that
// registers every video as a portrait (1080x1920) Remotion composition.
//
// Usage:
//   node color-shape-names/register-compositions.js
// ============================================================================
...
const CATALOG_PATH = path.join(PROJECT_ROOT, "color-shape-names", "catalog.json");
const ROOT_TSX_PATH = path.join(PROJECT_ROOT, "src", "ColorshapeRoot.tsx");
const BACKUP_PATH = path.join(PROJECT_ROOT, "src", "ColorshapeRoot.tsx.backup");
...
function main() {
  console.log("============================================");
  console.log("  Register All Color & Shape Names in ColorshapeRoot.tsx");
  console.log("============================================\n");
  ...
  // Back up existing ColorshapeRoot.tsx
  if (fs.existsSync(ROOT_TSX_PATH)) {
    fs.copyFileSync(ROOT_TSX_PATH, BACKUP_PATH);
    console.log(`Backed up existing ColorshapeRoot.tsx to ColorshapeRoot.tsx.backup`);
  }

  // ---------- Generate ColorshapeRoot.tsx content ----------
  let content = "";
  ...
  content += `export const ColorshapeRemotionRoot: React.FC = () => {\n`;
  content += `  return (\n`;
  content += `    <>\n`;
  ...
  console.log(`\nColorshapeRoot.tsx generated successfully!`);
