#!/usr/bin/env node
// ============================================================================
// Auto-Register All Bird Name Compositions in BirdRoot.tsx
// ============================================================================
// Reads bird-names/catalog.json and generates a new BirdRoot.tsx that
...
const CATALOG_PATH = path.join(PROJECT_ROOT, "bird-names", "catalog.json");
const ROOT_TSX_PATH = path.join(PROJECT_ROOT, "src", "BirdRoot.tsx");
const BACKUP_PATH = path.join(PROJECT_ROOT, "src", "BirdRoot.tsx.backup");

const FPS = 30;

// ---------- Helpers ----------

// Convert an id like "birds-tropical-1" to PascalCase "BirdsTropical1"
...
function main() {
  console.log("============================================");
  console.log("  Register All Bird Names in BirdRoot.tsx");
  console.log("============================================\n");
  ...
  // Back up existing BirdRoot.tsx
  if (fs.existsSync(ROOT_TSX_PATH)) {
    fs.copyFileSync(ROOT_TSX_PATH, BACKUP_PATH);
    console.log(`Backed up existing BirdRoot.tsx to BirdRoot.tsx.backup`);
  }

  // ---------- Generate BirdRoot.tsx content ----------
  let content = "";
  ...
  content += `export const BirdRemotionRoot: React.FC = () => {\n`;
  content += `  return (\n`;
  content += `    <>\n`;
  ...
  console.log(`\nBirdRoot.tsx generated successfully!`);
