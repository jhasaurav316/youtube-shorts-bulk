#!/usr/bin/env node
// ============================================================================
// Auto-Register All Animal Name Compositions in DinosaurRoot.tsx
// ============================================================================
// Reads dinosaur-names/catalog.json and generates a new DinosaurRoot.tsx that
// registers every video as a portrait (1080x1920) Remotion composition.
//
// Usage:
//   node dinosaur-names/register-compositions.js
// ============================================================================
...
const CATALOG_PATH = path.join(PROJECT_ROOT, "dinosaur-names", "catalog.json");
const ROOT_TSX_PATH = path.join(PROJECT_ROOT, "src", "DinosaurRoot.tsx");
const BACKUP_PATH = path.join(PROJECT_ROOT, "src", "DinosaurRoot.tsx.backup");
...
function main() {
  console.log("============================================");
  console.log("  Register All Dinosaur Names in DinosaurRoot.tsx");
  console.log("============================================\n");
  ...
  // Back up existing DinosaurRoot.tsx
  if (fs.existsSync(ROOT_TSX_PATH)) {
    fs.copyFileSync(ROOT_TSX_PATH, BACKUP_PATH);
    console.log(`Backed up existing DinosaurRoot.tsx to DinosaurRoot.tsx.backup`);
  }

  // ---------- Generate DinosaurRoot.tsx content ----------
  let content = "";
  ...
  content += `export const DinosaurRemotionRoot: React.FC = () => {\n`;
  content += `  return (\n`;
  content += `    <>\n`;
  ...
  console.log(`\nDinosaurRoot.tsx generated successfully!`);
