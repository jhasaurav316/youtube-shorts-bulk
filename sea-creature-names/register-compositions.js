#!/usr/bin/env node
// ============================================================================
// Auto-Register All Animal Name Compositions in SeaCreatureRoot.tsx
// ============================================================================
// Reads sea-creature-names/catalog.json and generates a new SeaCreatureRoot.tsx that
// registers every video as a portrait (1080x1920) Remotion composition.
//
// Usage:
//   node sea-creature-names/register-compositions.js
// ============================================================================
...
const CATALOG_PATH = path.join(PROJECT_ROOT, "sea-creature-names", "catalog.json");
const ROOT_TSX_PATH = path.join(PROJECT_ROOT, "src", "SeaCreatureRoot.tsx");
const BACKUP_PATH = path.join(PROJECT_ROOT, "src", "SeaCreatureRoot.tsx.backup");
...
function main() {
  console.log("============================================");
  console.log("  Register All Sea Creature Names in SeaCreatureRoot.tsx");
  console.log("============================================\n");
  ...
  // Back up existing SeaCreatureRoot.tsx
  if (fs.existsSync(ROOT_TSX_PATH)) {
    fs.copyFileSync(ROOT_TSX_PATH, BACKUP_PATH);
    console.log(`Backed up existing SeaCreatureRoot.tsx to SeaCreatureRoot.tsx.backup`);
  }

  // ---------- Generate SeaCreatureRoot.tsx content ----------
  let content = "";
  ...
  content += `export const SeaCreatureRemotionRoot: React.FC = () => {\n`;
  content += `  return (\n`;
  content += `    <>\n`;
  ...
  console.log(`\nSeaCreatureRoot.tsx generated successfully!`);
