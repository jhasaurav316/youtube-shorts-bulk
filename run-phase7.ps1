# ============================================================================
# ONE-CLICK Phase 7 Render (50 Videos)
# Countries (30) + Sports (20) = 50 videos
# Usage: cd C:\test\youtube-shorts-bulk && .\run-phase7.ps1
# ============================================================================
...
Write-Host "  PHASE 7: 50 Videos (30 Countries + 20 Sports)" -ForegroundColor Cyan
Write-Host "================================================================" -ForegroundColor Cyan
Write-Host ""
...
$catalogs = @(
    @{ Path = "country-names\catalog.json"; Name = "Countries"; FromIdx = 0; ToIdx = 29 },
    @{ Path = "sport-names\catalog.json"; Name = "Sports"; FromIdx = 0; ToIdx = 19 }
)
...
node (Join-Path $ProjectDir "country-names\register-compositions.js")
