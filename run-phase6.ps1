# ============================================================================
# ONE-CLICK Phase 6 Render (50 Videos)
# Instruments (20 remaining) + Vehicles (30) = 50 videos
# Usage: cd C:\test\youtube-shorts-bulk && .\run-phase6.ps1
# ============================================================================
...
Write-Host "  PHASE 6: 50 Videos (20 Instruments + 30 Vehicles)" -ForegroundColor Cyan
Write-Host "================================================================" -ForegroundColor Cyan
Write-Host ""
...
$catalogs = @(
    @{ Path = "instrument-names\catalog.json"; Name = "Instruments (remaining)"; FromIdx = 10; ToIdx = 29 },
    @{ Path = "vehicle-names\catalog.json"; Name = "Vehicles"; FromIdx = 0; ToIdx = 29 }
)
...
node (Join-Path $ProjectDir "vehicle-names\register-compositions.js")
