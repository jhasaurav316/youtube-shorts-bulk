# ============================================================================
# ONE-CLICK Phase 5 Render (50 Videos)
# Insects (10 remaining) + Dinosaurs (30) + Instruments (10) = 50 videos
# Usage: cd C:\test\youtube-shorts-bulk && .\run-phase5.ps1
# ============================================================================
...
Write-Host "  PHASE 5: 50 Videos (10 Insects + 30 Dinosaurs + 10 Instruments)" -ForegroundColor Cyan
Write-Host "================================================================" -ForegroundColor Cyan
Write-Host ""
...
$catalogs = @(
    @{ Path = "insect-names\catalog.json"; Name = "Insects (remaining)"; FromIdx = 20; ToIdx = 29 },
    @{ Path = "dinosaur-names\catalog.json"; Name = "Dinosaurs"; FromIdx = 0; ToIdx = 29 },
    @{ Path = "instrument-names\catalog.json"; Name = "Instruments"; FromIdx = 0; ToIdx = 9 }
)
...
node (Join-Path $ProjectDir "insect-names\register-compositions.js")
node (Join-Path $ProjectDir "dinosaur-names\register-compositions.js")
node (Join-Path $ProjectDir "instrument-names\register-compositions.js")
