#!/usr/bin/env node
// ============================================================================
// Auto-Register All Animal Name Compositions in CountryRoot.tsx
// ============================================================================
// Reads country-names/catalog.json and generates a new CountryRoot.tsx that
// registers every video as a portrait (1080x1920) Remotion composition.
//
// Usage:
//   node country-names/register-compositions.js
// ============================================================================
...
const CATALOG_PATH = path.join(PROJECT_ROOT, "country-names", "catalog.json");
const ROOT_TSX_PATH = path.join(PROJECT_ROOT, "src", "CountryRoot.tsx");
const BACKUP_PATH = path.join(PROJECT_ROOT, "src", "CountryRoot.tsx.backup");
...
function main() {
  console.log("============================================");
  console.log("  Register All Country Names in CountryRoot.tsx");
  console.log("============================================\n");
  ...
  // Back up existing CountryRoot.tsx
  if (fs.existsSync(ROOT_TSX_PATH)) {
    fs.copyFileSync(ROOT_TSX_PATH, BACKUP_PATH);
    console.log(`Backed up existing CountryRoot.tsx to CountryRoot.tsx.backup`);
  }

  // ---------- Generate CountryRoot.tsx content ----------
  let content = "";
  ...
  content += `export const CountryRemotionRoot: React.FC = () => {\n`;
  content += `  return (\n`;
  content += `    <>\n`;
  ...
  console.log(`\nCountryRoot.tsx generated successfully!`);
