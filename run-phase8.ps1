# ============================================================================
# ONE-CLICK Phase 8 Render (50 Videos)
# Sports (10 remaining) + Food (30) + Colors & Shapes (10) = 50 videos
# Usage: cd C:\test\youtube-shorts-bulk && .\run-phase8.ps1
# ============================================================================
...
Write-Host "  PHASE 8: 50 Videos (10 Sports + 30 Food + 10 Colors)" -ForegroundColor Cyan
Write-Host "================================================================" -ForegroundColor Cyan
Write-Host ""
...
$catalogs = @(
    @{ Path = "sport-names\catalog.json"; Name = "Sports (remaining)"; FromIdx = 20; ToIdx = 29 },
    @{ Path = "food-names\catalog.json"; Name = "Food"; FromIdx = 0; ToIdx = 29 },
    @{ Path = "color-shape-names\catalog.json"; Name = "Colors & Shapes"; FromIdx = 0; ToIdx = 9 }
)
...
node (Join-Path $ProjectDir "sport-names\register-compositions.js")
node (Join-Path $ProjectDir "food-names\register-compositions.js")
node (Join-Path $ProjectDir "color-shape-names\register-compositions.js")
