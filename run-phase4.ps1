# ============================================================================
# ONE-CLICK Phase 4 Render (50 Videos)
# Sea Creatures (30) + Insects (20) = 50 videos
# Usage: cd C:\test\youtube-shorts-bulk && .\run-phase4.ps1
# ============================================================================
...
Write-Host "  PHASE 4: 50 Videos (30 Sea Creatures + 20 Insects)" -ForegroundColor Cyan
Write-Host "================================================================" -ForegroundColor Cyan
Write-Host ""
...
$catalogs = @(
    @{ Path = "sea-creature-names\catalog.json"; Name = "Sea Creatures"; FromIdx = 0; ToIdx = 29 },
    @{ Path = "insect-names\catalog.json"; Name = "Insects"; FromIdx = 0; ToIdx = 19 }
)
...
node (Join-Path $ProjectDir "sea-creature-names\register-compositions.js")
