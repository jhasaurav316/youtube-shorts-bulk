#!/usr/bin/env node
// ============================================================================
// Auto-Register All Animal Name Compositions in FoodRoot.tsx
// ============================================================================
// Reads food-names/catalog.json and generates a new FoodRoot.tsx that
// registers every video as a portrait (1080x1920) Remotion composition.
//
// Usage:
//   node food-names/register-compositions.js
// ============================================================================
...
const CATALOG_PATH = path.join(PROJECT_ROOT, "food-names", "catalog.json");
const ROOT_TSX_PATH = path.join(PROJECT_ROOT, "src", "FoodRoot.tsx");
const BACKUP_PATH = path.join(PROJECT_ROOT, "src", "FoodRoot.tsx.backup");
...
function main() {
  console.log("============================================");
  console.log("  Register All Food Names in FoodRoot.tsx");
  console.log("============================================\n");
  ...
  // Back up existing FoodRoot.tsx
  if (fs.existsSync(ROOT_TSX_PATH)) {
    fs.copyFileSync(ROOT_TSX_PATH, BACKUP_PATH);
    console.log(`Backed up existing FoodRoot.tsx to FoodRoot.tsx.backup`);
  }

  // ---------- Generate FoodRoot.tsx content ----------
  let content = "";
  ...
  content += `export const FoodRemotionRoot: React.FC = () => {\n`;
  content += `  return (\n`;
  content += `    <>\n`;
  ...
  console.log(`\nFoodRoot.tsx generated successfully!`);
