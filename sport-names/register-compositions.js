#!/usr/bin/env node
// ============================================================================
// Auto-Register All Animal Name Compositions in SportRoot.tsx
// ============================================================================
// Reads sport-names/catalog.json and generates a new SportRoot.tsx that
// registers every video as a portrait (1080x1920) Remotion composition.
//
// Usage:
//   node sport-names/register-compositions.js
// ============================================================================
...
const CATALOG_PATH = path.join(PROJECT_ROOT, "sport-names", "catalog.json");
const ROOT_TSX_PATH = path.join(PROJECT_ROOT, "src", "SportRoot.tsx");
const BACKUP_PATH = path.join(PROJECT_ROOT, "src", "SportRoot.tsx.backup");
...
function main() {
  console.log("============================================");
  console.log("  Register All Sport Names in SportRoot.tsx");
  console.log("============================================\n");
  ...
  // Back up existing SportRoot.tsx
  if (fs.existsSync(ROOT_TSX_PATH)) {
    fs.copyFileSync(ROOT_TSX_PATH, BACKUP_PATH);
    console.log(`Backed up existing SportRoot.tsx to SportRoot.tsx.backup`);
  }

  // ---------- Generate SportRoot.tsx content ----------
  let content = "";
  ...
  content += `export const SportRemotionRoot: React.FC = () => {\n`;
  content += `  return (\n`;
  content += `    <>\n`;
  ...
  console.log(`\nSportRoot.tsx generated successfully!`);
