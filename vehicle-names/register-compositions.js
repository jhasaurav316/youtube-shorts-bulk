#!/usr/bin/env node
// ============================================================================
// Auto-Register All Animal Name Compositions in VehicleRoot.tsx
// ============================================================================
// Reads vehicle-names/catalog.json and generates a new VehicleRoot.tsx that
// registers every video as a portrait (1080x1920) Remotion composition.
//
// Usage:
//   node vehicle-names/register-compositions.js
// ============================================================================
...
const CATALOG_PATH = path.join(PROJECT_ROOT, "vehicle-names", "catalog.json");
const ROOT_TSX_PATH = path.join(PROJECT_ROOT, "src", "VehicleRoot.tsx");
const BACKUP_PATH = path.join(PROJECT_ROOT, "src", "VehicleRoot.tsx.backup");
...
function main() {
  console.log("============================================");
  console.log("  Register All Vehicle Names in VehicleRoot.tsx");
  console.log("============================================\n");
  ...
  // Back up existing VehicleRoot.tsx
  if (fs.existsSync(ROOT_TSX_PATH)) {
    fs.copyFileSync(ROOT_TSX_PATH, BACKUP_PATH);
    console.log(`Backed up existing VehicleRoot.tsx to VehicleRoot.tsx.backup`);
  }

  // ---------- Generate VehicleRoot.tsx content ----------
  let content = "";
  ...
  content += `export const VehicleRemotionRoot: React.FC = () => {\n`;
  content += `  return (\n`;
  content += `    <>\n`;
  ...
  console.log(`\nVehicleRoot.tsx generated successfully!`);
